...
class K2Director:
    ...
    def predict(self, X, return_model_choice=False):
        ...
        # Para tracking, determinar quÃ© modelo "dominÃ³" la decisiÃ³n
        model_choices = []
    ...
    def configure(self, rf_model, rf_scaler, tf_model, tf_scaler):
        ...
        self.decision_stats = {'RandomForest': 0, 'TensorFlow': 0}
        logger.info("âœ… K2 Director configurado con Soft Voting (RF: 75%, TF: 25%)")

    def get_stats(self):
        """Retorna estadÃ­sticas de uso de modelos"""
    ...
    def reset_stats(self):
        """Reinicia las estadÃ­sticas de uso"""
        self.decision_stats = {'RandomForest': 0, 'TensorFlow': 0}
